...
// texturas
#define sol_path "Textures/2k_sun.jpg"
#define mercurio_path "Textures/2k_mercury.jpg"
#define venus_path "Textures/2k_venus_surface.jpg"
#define terra_path "Textures/2k_earth.jpg"
#define lua_path "Textures/2k_moon.jpg"
#define marte_path "Textures/2k_mars.jpg"
#define jupiter_path "Textures/2k_jupiter.jpg"
#define saturno_path "Textures/2k_saturn.jpg"
#define urano_path "Textures/2k_uranus.jpg"
#define neptuno_path "Textures/2k_neptune.jpg"
...
int main()
{
    ...
    FT_Face face;
    if (FT_New_Face(ft, "Textures/BlinkMacSystemFont-Bold.otf", 0, &face))
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        default:
            if (planeta == 0) {
                renderText(TextShader, "Sistema Solar ", 25.0f, SCR_HEIGHT - 30.0f, 0.50f, glm::vec3(1.0f, 1.0f, 1.0f));
            }
            break;
        }
...
{
    renderText(s, "Planeta: " + Info.Nome, 25.0f, SCR_HEIGHT - 30.0f, 0.35f, glm::vec3(1.0f, 1.0f, 1.0f));
    renderText(s, "Velocidade (km/s): " + Info.Velocidade, 25.0f, SCR_HEIGHT - 50.0f, 0.35f, glm::vec3(1.0f, 1.0f, 1.0f));
    renderText(s, "Massa (kg * 10^24): " + Info.Massa, 25.0f, SCR_HEIGHT - 70.0f, 0.35f, glm::vec3(1.0f, 1.0f, 1.0f));
    renderText(s, "Diametro (km): " + Info.Diametro, 25.0f, SCR_HEIGHT - 90.0f, 0.35f, glm::vec3(1.0f, 1.0f, 1.0f));
}
